...
## Project Structure
    ...
    ├── testdeployedissue_d_27112  # Django project configurations
...
1. Clone this repo and `cd testdeployedissue_d_27112`
...
2. Clone this repo and `cd testdeployedissue_d_27112`
